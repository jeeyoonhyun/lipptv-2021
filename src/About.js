    ...
    return (
        <div className='section' id='about'>
            <div className='section-inner-half'>
                <div className='box-big about'>
                    <div className='text-big'>LIPP TV IS THE FINAL PERFORMANCE PROJECT OF THE LIVE IMAGE PROCESSING AND PERFORMANCE (LIPP) CLASS AT NYU’S ITP.</div>
                </div>
            </div>
            <div className='section-inner-half'>
                <div className='title text-small bodytext-about about-heading'>ABOUT</div>
                <div className='text-small bodytext-about'>A CREATIVE RESPONSE TO HOW CODE, VIDEO NETWORKS, AND ART CAN BE USED TO CREATE A NEW EXPERIENCE IN LIVE PERFORMANCE.
