function About() {
    return (
        <div className='section section-about' id='about'>
            <div className='headline headline-about'>LIPP TV IS THE FINAL PERFORMANCE PROJECT OF THE LIVE IMAGE PROCESSING AND PERFORMANCE (LIPP) CLASS AT NYU’S ITP.</div>
            <div>
                <div className='title title-about'>ABOUT</div>
                <div className='bodytext bodytext-about'>A CREATIVE RESPONSE TO HOW CODE, VIDEO NETWORKS, AND ART CAN BE USED TO CREATE A NEW EXPERIENCE IN LIVE PERFORMANCE.
